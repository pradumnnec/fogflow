...
/**
     ...
     *
     **/
    enoughPlaces = function(freePlaces,minToPark)
    {
        return freePlaces > (minToPark);
    } 
...
//      query:      query aditional information from the assigned nearby broker
...
exports.handler = function(contextEntity, publish, query, subscribe)
{
    ...
    if (contextEntity.attributes.ParkingRequest != null) {
        ...
        var parkingSavedLat = null;
        var parkingSavedLon = null;
        var minSaved;
        ...
        var handleQueryResult = async function(entityList) {
            for(var i=0; i<entityList.length; i++) {
                ...
                var places = enoughPlaces(entity.attributes.FreeParkingSpots.value,minToPark);
                ...
                if(places && (parkingSaved == null || minToPark < minSaved)){
                    parkingSaved = entity;
                    minSaved = minToPark;
                    parkingSavedLat = latitudeEntity;
                    parkingSavedLon = longitudeEntity;
            ...
            if(parkingSaved == null){
                ...
                var parkingCoord = {
                    latitude: parkingSavedLat,
                    longitude: parkingSavedLon
                };    
                updateEntity.attributes.RecommendedParkingCoord = {type: 'object', value: parkingCoord};
            }
